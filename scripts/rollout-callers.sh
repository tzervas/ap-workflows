...
#
#   bash scripts/rollout-callers.sh                     # dry run, whole fleet
#   REPOS="a b c" bash scripts/rollout-callers.sh        # dry run, named repos
#   APPLY=1 REPOS="a b c" bash scripts/rollout-callers.sh
#
...
# https://github.com/$OWNER/ap-workflows/blob/main/.github/workflows/reusable-ci-autodetect.yml
#
...
jobs:
  fleet-ci:
    uses: $OWNER/ap-workflows/.github/workflows/reusable-ci-autodetect.yml@$PIN
    with:
...
# https://github.com/$OWNER/ap-workflows/blob/main/.github/workflows/reusable-scan-secrets-vuln.yml
#
...
jobs:
  fleet-security:
    uses: $OWNER/ap-workflows/.github/workflows/reusable-scan-secrets-vuln.yml@$PIN
    with:
      tier: auto
      main-branches: '$main_branches'
EOF
